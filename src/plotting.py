...
def plot_results_over_lambdas(utility_mean, utility_max, utility_min, benefit_delta_mean, benefit_delta_max, benefit_delta_min, lambdas, file_path=None):
    ...
    ax1.set_xscale('log')
    ax1.fill_between(lambdas, utility_min, utility_max, alpha=0.3, edgecolor='#060080', facecolor='#928CFF')
    ax2.plot(lambdas, benefit_delta_mean)
    ax2.set_xlabel("Lambda")
    ax2.set_ylabel("Mean Benefit Delta")
    ax2.set_xscale('log')
    ax2.fill_between(lambdas, benefit_delta_min, benefit_delta_max, alpha=0.3, edgecolor='#060080', facecolor='#928CFF')
